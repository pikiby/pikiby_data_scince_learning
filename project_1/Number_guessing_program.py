...
def guessing_funс ():    
    number = random_funс ()
    """
    Функция получает рандомное число из функции random_number
    Затем пытается угадать его максимально быстрам способом. 
    После каждой попытки угадать, функция узнает больше ли ответ загаданного числа или меньше. 

    Returns:
        count (function): количество попыток, затраченных на угадывание
    """    
